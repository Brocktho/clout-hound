...
@export var trick_resources: Array[Trick] = []
@export var trick_stale_factor: float = 0.3

@export var ragdoll_bail_sfx: Array[AudioStream] = [
	preload("uid://8deifufc1ixq"),
	preload("uid://buumrqtvcn20k"),
	preload("uid://c3djas7rbmtjf"),
	preload("uid://crt3dvsjid6nx"),
	preload("uid://baawoyr1mjyp3"),
	preload("uid://ci50iwehugsh4"),
	preload("uid://4mmvpm3v6q6w"),
	preload("uid://bnlqgetoeerdg"),
	preload("uid://0xcoubrxo50s"),
	preload("uid://qbowwejsqds5"),
	preload("uid://cwwhbhr63qme6"),
	preload("uid://theg7uwnjebn")
]
@export var jump_sfx: Array[AudioStream] = [
	preload("uid://c4ann1gv7fmhu"),
	preload("uid://dign0luqkf8t5"),
	preload("uid://c4do6ib5ij0mc"),
	preload("uid://exr4hj162fi7"),
	preload("uid://n7rrjmv1wpee"),
	preload("uid://ccpnstw4vc7yi")
]
@export var landing_sfx: Array[AudioStream] = [
	preload("uid://cd0jlfkpftas6"),
	preload("uid://codx2xuhb8cc2"),
	preload("uid://b3wiid8rindt"),
	preload("uid://be06flrfx36mt"),
	preload("uid://y0l2pjbc3xgc"),
	preload("uid://ccodc6luts1eg")
]
@export var land_rail_sfx: Array[AudioStream] = [
	preload("uid://dmr3pd1mtx8sq"),
	preload("uid://ccmeq44gp17u"),
	preload("uid://dsunfmvqrx004"),
	preload("uid://b8var5rhti3w2"),
	preload("uid://dvqoae8ud21hv"),
	preload("uid://cekonqaecj67v")
]
@export var airborne_sfx: AudioStream = preload("uid://bud4vl4le1lm1")
@export var moving_sfx: Array[AudioStream] = [
	preload("uid://bqjpy847cairm"),
	preload("uid://dcbbfwb3n82pl"),
	preload("uid://b8tdvj6vyapts"),
]
@export var grind_sfx: Array[AudioStream] = [
	preload("uid://b2xqckqmnubte"),
	preload("uid://deoxd7xawgeam"),
	preload("uid://b68ihy3uiplqv"),
	preload("uid://dtw0vwdb5ppe"),
	preload("uid://d2ogukoq7t2a7"),
	preload("uid://d3a42j2kjm4ku"),
	preload("uid://bv4jv4nt7n4ep"),
	preload("uid://d7xqnaoi6fu3"),
	preload("uid://jeu5kondyrm6"),
	preload("uid://dwrxknha217vc"),
	preload("uid://d1kma8arfaw4b"),
	preload("uid://bb7as1mxob24u")
]
@export var trick_completion_sfx: Array[AudioStream] = [
	preload("uid://b7xdld5ri143h"),
	preload("uid://bdypvel6nh2pc")
]
...
func _ready() -> void:
	...
	var default_mesh = preload("uid://bhjvh3vj2grbx")
	
	if(idle_frames.size() == 0): 
		idle_frames = [
			default_mesh,
			preload("uid://c4j2ah624w0io"),
			default_mesh,
			preload("uid://cr06pfq2niwus")
		]
		
	if(walk_frames.size() == 0): 
		walk_frames = [
			preload("uid://c13hr3nbqki83"),
			preload("uid://deu68ikulpl2o"),
			preload("uid://nsh8omrnxvbd")
		]
		
	if(trick_frames.size() == 0):
		trick_frames = [
			preload("uid://cvsfw8j64pfu1"),
			preload("uid://dqusv5nvacaei"),
			preload("uid://b7nrdwf1bshob"),
			preload("uid://cytpje06ksm6c")
		]
...
func setup_outline() -> void:
	...
	outline_material.shader = load("uid://c8agwqmfjhcyr")
...
func show_settings(show_pointer_lock_hint: bool) -> void:
	...
	var settings_scene = load("uid://be50rwf3yw6y")
	if settings_scene:
...
func consume_trick_stale(trick: Trick) -> float:
